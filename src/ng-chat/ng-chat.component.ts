...
export class NgChat implements OnInit, IChatController {
    ...
    private bootstrapChat(): void
    {
        ...
        if (!this.isBootstrapped){
            ...
            if (initializationException)
            {
                ...
                console.error(`An exception has occurred while initializing ng-chat. Details: ${initializationException}`);
    ...
    private getClosestWindow(window: Window): any //Window | undefined
    {
